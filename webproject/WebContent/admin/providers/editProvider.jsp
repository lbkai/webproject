...
<body>
<form id="myform" action="doEditProvider.jsp" method="post" >
	<table>
	    <tr>
			<td>供应商ID</td><td><input style="text" name="providerID"  value="${pv.providerID  }" readonly="readonly" /></td>
		</tr>
		<tr>
			<td>供应商名称</td><td><input id="provider_name" style="text" name="provider_name" value="${pv.provider_name }" onclick="checkName()" onchange="checkName()"  onblur="checkName()" /></td>
			<td><label id="nameresult" ></label></td>
		</tr>	
		<tr>
			<td>地址</td><td><input id="provider_add" style="text" name="provider_add" value="${pv.provider_add }" onclick="checkAdd()" onchange="checkAdd()" onblur="checkAdd()" /></td>
			<td><label id="addresult" ></label></td>
		</tr>
		<tr>
			<td>联系方式</td><td><input id="provider_tel" style="text" name="provider_tel" value="${pv.provider_tel }" onclick="checkTel()" onchange="checkTel()" onblur="checkTel()" /></td>
			<td><label id="telresult" ></label></td>
		</tr>
		<tr>
			<td>ACCOUNT</td><td><input style="text" name="account" value="${pv.account }" /></td>
		</tr>		
		<tr>	
			<td>邮箱</td><td><input id="email" style="text" name="email" value="${pv.email }" onclick="checkEmail()" onchange="checkEmail()" onblur="checkEmail()" /></td>			
